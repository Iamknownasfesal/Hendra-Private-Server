...
| [38-handlers.md](38-handlers.md) | Dispatch modes, inventory rules, portals, hit claims | `networking/handlers/` |
...
The C# server is **547 files**. About **225** were opened and read, including every behaviour, every
