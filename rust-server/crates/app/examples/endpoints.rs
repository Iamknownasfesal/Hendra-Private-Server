...
const ENDPOINTS: &[(&str, Option<&str>)] = &[
    ...
    ("privateMessage/send", None),
    ("privateMessage/delete", None),
    ("guild/getBoard", None),
    ("guild/setBoard", None),
    ("guild/listMembers", None),
    ("account/purchaseCharSlot", None),
    ("account/rank", None),
    ("account/sendVerifyEmail", None),
    ("account/forgotPassword", None),
    ("account/resetPassword", None),
    ...
    ("app/globalNews", None),
    ("char/purchaseClassUnlock", None),
    ("credits/add", None),
    ("credits/getoffers", None),
    ("dailyLogin/fetchCalendar", None),
    ("inGameNews/getNews", None),
    ("picture/get", None),
