...
pub const BEHAVIOURS: &[Entry] = &[
    Entry {
        ...
        params: &[
            Param {
                ...
                value: "tiles",
                default: "20",
                doc: "How far away a player can be and still be shot at.",
            },
            Param {
                name: "count",
                position: Some(1),
                value: "number",
                default: "1",
                doc: "Projectiles per shot. More than one spreads them over `shoot_angle`.",
            },
            Param {
                name: "shoot_angle",
                position: Some(2),
                value: "degrees",
                default: "0",
                doc: "The gap between projectiles in a burst.",
            },
            Param {
                name: "projectile",
                position: Some(3),
                value: "number",
                default: "0",
                doc: "Which of the enemy's projectiles to fire, by index in its object data.",
            },
            Param {
                name: "fixed_angle",
                position: None,
                value: "degrees",
                default: "aims at the target",
                doc: "Fires this direction regardless of where anyone is standing.",
            },
            Param {
                name: "angle_offset",
                position: Some(6),
                value: "degrees",
                default: "0",
                doc: "Turns the whole burst by this much.",
            },
            Param {
                name: "default_angle",
                position: None,
                value: "degrees",
                default: "aims at the target",
                doc: "The direction to fire in when there is nobody to aim at.",
            },
            Param {
                name: "predictive",
                position: None,
                value: "0 to 1",
                default: "0",
                doc: "How much to lead a moving target. 1 aims where they will be.",
            },
            Param {
                name: "cooldown_offset",
                position: Some(9),
                value: "ms",
                default: "0",
                doc: "Waits this long before the first shot, so several shooters do not fire in step.",
            },
            Param {
                name: "cooldown",
                position: Some(10),
                value: "ms",
                default: "1000",
                doc: "The wait between shots.",
            },
        ],
        ignored: &[Ignored {
            name: "rotate_angle",
            why: "the runtime does not turn a burst between shots",
            misread: false,
        }],
        note: None,
    },
    ...
    Entry {
        ...
        params: &[
            ...
            Param {
                ...
                value: "tiles",
                default: "10",
                doc: "How far away it notices a player.",
            },
            Param {
                name: "range",
                position: Some(2),
                value: "tiles",
                default: "6",
                doc: "How close it gets before stopping.",
            },
            Param {
                name: "duration",
                position: Some(3),
                value: "ms",
                default: "as long as the state lasts",
                doc: "How long one chase lasts before it rests.",
            },
            Param {
                name: "cooldown",
                position: Some(4),
    ...
    Entry {
        ...
        params: &[
            ...
            Param {
                ...
                value: "tiles",
                default: "10",
                doc: "How far away it looks for what to circle.",
            },
            Param {
                name: "target",
                position: Some(3),
                value: "an object name",
                default: "the nearest player",
                doc: "What to circle. Guards circle their boss this way.",
            },
        ],
        ignored: &[
            Ignored {
                name: "speed_variance",
                why: "the runtime gives every orbiter the same speed",
                misread: false,
            },
            Ignored {
                name: "radius_variance",
                why: "the runtime gives every orbiter the same radius",
                misread: false,
            },
            Ignored {
                name: "orbit_clockwise",
                why: "the runtime picks the direction itself",
                misread: false,
            },
        ],
        note: None,
    ...
    Entry {
        ...
        params: &[
            ...
            Param {
                ...
                value: "tiles",
                default: "8",
                doc: "The distance it tries to hold.",
            },
        ],
        ignored: &[],
        note: None,
    ...
    Entry {
        ...
        params: &[
            ...
            Param {
                ...
                value: "tiles",
                default: "5",
                doc: "How far it may stray before returning.",
            },
        ],
        ignored: &[],
        note: None,
    ...
    Entry {
        ...
        params: &[
            ...
            Param {
                ...
                value: "number",
                default: "5",
                doc: "The ground height it will not go below.",
            },
        ],
        ignored: &[],
        note: None,
    ...
    Entry {
        ...
        params: &[
            Param {
                ...
                value: "hit points",
                default: "100",
                doc: "How much each heal restores.",
            },
            Param {
                name: "cooldown",
                position: Some(1),
    ...
    Entry {
        ...
        params: &[
            Param {
                ...
                value: "tiles",
                default: "10",
                doc: "How far the healing reaches.",
            },
            Param {
                name: "group",
                position: Some(1),
                value: "a group name",
                default: "anything nearby",
                doc: "Which group is healed.",
            },
            Param {
                name: "cooldown",
                position: Some(2),
    ...
    Entry {
        ...
        params: &[
            ...
            Param {
                ...
                value: "number",
                default: "5",
                doc: "How many it will have alive at once.",
            },
            Param {
                name: "initial_spawn",
                position: Some(2),
                value: "0 to 1",
                default: "0.5",
                doc: "The share of `max_children` created at once on entering the state.",
            },
            Param {
                name: "cooldown",
                position: Some(3),
                value: "ms",
                default: "1000",
                doc: "The wait between replacements.",
            },
            Param {
                name: "gives_no_xp",
                position: None,
                value: "true or false",
                default: "true",
                doc: "Whether killing the children is worth nothing, which is what stops a spawner being an experience farm.",
            },
        ],
        ignored: &[],
        note: None,
    ...
    Entry {
        ...
        params: &[
            Param {
                ...
                value: "a group name",
                default: "nothing",
                doc: "The group to draw children from.",
            },
            Param {
                name: "max_children",
                position: Some(1),
            ...
            Param {
                ...
                value: "0 to 1",
                default: "0.5",
                doc: "The share created at once on entering the state.",
            },
            Param {
                name: "cooldown",
                position: Some(3),
            ...
            Param {
                ...
                value: "true or false",
                default: "true",
                doc: "Whether the children are worth nothing.",
            },
        ],
        ignored: &[],
        note: None,
    ...
    Entry {
        ...
        params: &[
            ...
            Param {
                ...
                value: "tiles",
                default: "10",
                doc: "How far out it counts its own kind.",
            },
            Param {
                name: "density_max",
                position: Some(2),
                value: "number",
                default: "5",
                doc: "How many may stand within that radius before it stops.",
            },
            Param {
                name: "cooldown",
                position: Some(3),
    ...
    Entry {
        ...
        params: &[
            Param {
                ...
                value: "number",
                default: "5",
                doc: "How many may stand nearby before it stops.",
            },
            Param {
                name: "initial_spawn",
                position: Some(1),
                value: "0 to 1",
                default: "unused",
                doc: "Read by the C# and ignored here.",
            },
            Param {
                name: "cooldown",
                position: Some(2),
    ...
    Entry {
        ...
        params: &[
            ...
            Param {
                ...
                value: "tiles",
                default: "5",
                doc: "How far it throws.",
            },
            Param {
                name: "angle",
                position: None,
                value: "degrees",
                default: "throws at a player",
                doc: "Throws this direction regardless of where anyone is.",
            },
            Param {
                name: "cooldown",
                position: Some(3),
                value: "ms",
                default: "1000",
                doc: "The wait between throws.",
            },
        ],
        ignored: &[
            Ignored {
                name: "min_range",
                why: "the runtime throws at one distance",
                misread: false,
            },
            Ignored {
                name: "max_range",
                why: "the runtime throws at one distance; write `range`",
                misread: false,
            },
            Ignored {
                name: "min_angle",
                why: "the runtime throws at one angle",
                misread: false,
            },
            Ignored {
                name: "max_angle",
                why: "the runtime throws at one angle; write `angle`",
                misread: false,
            },
            Ignored {
                name: "toss_invis",
                misread: true,
                why: "write `invisi_toss` instead, which is the same behaviour",
            },
            Ignored {
                name: "cooldown_offset",
                why: "the runtime does not stagger the first throw",
                misread: false,
            },
        ],
        note: None,
    ...
    Entry {
        ...
        params: &[
            ...
            Param {
                ...
                value: "hit points",
                default: "100",
                doc: "What it does to everyone caught.",
            },
            Param {
                name: "range",
                position: Some(2),
            ...
            Param {
                name: "effect",
                position: None,
                value: "an effect name",
                default: "none",
                doc: "A condition effect applied to everyone caught.",
            },
            Param {
                ...
                value: "seconds or ms",
                default: "0",
                doc: "How long that effect lasts.",
            },
        ],
        ignored: &[],
        note: None,
    ...
    Entry {
        ...
        params: &[
            Param {
                name: "effect",
                position: Some(0),
                value: "an effect name or number",
                default: "nothing",
                doc: "Which effect to apply.",
            },
            Param {
                name: "duration",
                position: Some(1),
                value: "seconds or ms",
                default: "as long as the state lasts",
                doc: "How long it lasts. A value under 60 is read as seconds.",
            },
            Param {
                name: "perm",
                position: None,
                value: "anything",
                default: "not written",
                doc: "Written on its own to mean the effect lasts as long as the state does.",
            },
            Param {
                name: "range",
                position: Some(2),
                value: "tiles",
                default: "0",
                doc: "How far the effect reaches when it is not on itself.",
            },
            Param {
                name: "target",
                position: Some(3),
                value: "players, enemies or itself",
                default: "itself",
                doc: "Who is affected.",
            },
        ],
    ...
    Entry {
        ...
        params: &[Param {
            ...
            value: "number",
            default: "0",
            doc: "Which alternate texture from the object's data, where 0 is its own.",
        }],
        ignored: &[
            Ignored {
                name: "min_value",
                why: "the runtime sets one texture rather than cycling through a range",
                misread: false,
            },
            Ignored {
                name: "max_value",
            ...
            Ignored {
                name: "loop",
                why: "the runtime does not animate the texture",
                misread: false,
            },
            Ignored {
                name: "cooldown",
    ...
    Entry {
        ...
        params: &[
            Param {
                name: "color",
                position: Some(0),
                value: "0xRRGGBB as a number",
                default: "0",
                doc: "The colour to flash.",
            },
            Param {
                name: "flash_period",
                position: Some(1),
                value: "seconds",
                default: "0.5",
                doc: "How long one flash takes. Seconds here, unlike almost everything else.",
            },
            Param {
                name: "flash_repeats",
                position: Some(2),
    ...
    Entry {
        ...
        params: &[
            Param {
                ...
                value: "hit points",
                default: "0",
                doc: "Health added for each player counted.",
            },
            Param {
                name: "max_additional",
                position: Some(1),
                value: "hit points",
                default: "0",
                doc: "The most that can be added altogether.",
            },
            Param {
                name: "heal_after_max",
                position: Some(2),
            ...
            Param {
                ...
                value: "tiles",
                default: "20",
                doc: "How far out players are counted.",
            },
        ],
        ignored: &[],
        note: None,
    ...
    Entry {
        ...
        params: &[
            Param {
                ...
                value: "size a second",
                default: "0",
                doc: "How fast it changes. Negative shrinks.",
            },
            Param {
                name: "target",
                position: Some(1),
    ...
    Entry {
        ...
        params: &[
            Param {
                name: "probability",
                position: None,
                value: "0 to 1, or a percentage",
                default: "1",
                doc: "How likely it is to say anything when the cooldown is up.",
            },
            Param {
                name: "cooldown",
                position: None,
            ...
            Param {
                ...
                value: "1 or 0",
                default: "0",
                doc: "Whether the whole world hears it rather than the room.",
            },
        ],
        ignored: &[],
        note: None,
    ...
    Entry {
        ...
        params: &[
            ...
            Param {
                ...
                value: "a state name",
                default: "nothing",
                doc: "The state they are put into. It is a state of theirs, not of this enemy.",
            },
        ],
        ignored: &[],
        note: None,
    ...
    Entry {
        ...
        params: &[
            ...
            Param {
                ...
                value: "tiles",
                default: "10",
                doc: "How far away it will look for what it guards.",
            },
            Param {
                ...
                value: "tiles",
                default: "4",
                doc: "How close it stays.",
            },
            Param {
                name: "reprotect_range",
                position: Some(4),
                value: "tiles",
                default: "2",
                doc: "How far it may drift before returning.",
            },
        ],
        ignored: &[],
        note: None,
    ...
    Entry {
        ...
        params: &[
            ...
            Param {
                ...
                value: "tiles",
                default: "0",
                doc: "How far south of its spawn.",
            },
        ],
        ignored: &[],
        note: None,
    ...
    Entry {
        ...
        ignored: &[
            Ignored {
                name: "once",
                why: "the runtime always walks there once",
                misread: false,
            },
            Ignored {
                name: "is_map_position",
                why: "the runtime reads the position as relative to the spawn",
                misread: false,
            },
        ],
        note: None,
    ...
    Entry {
        ...
        params: &[
            ...
            Param {
                ...
                value: "tiles",
                default: "10",
                doc: "How far away it will start one.",
            },
            Param {
                name: "cooldown",
                position: Some(2),
    ...
    Entry {
        ...
        params: &[
            ...
            Param {
                ...
                value: "1 or 0",
                default: "0",
                doc: "Whether it spirals around a player rather than where it started.",
            },
        ],
        ignored: &[],
        note: None,
    ...
    Entry {
        ...
        params: &[
            ...
            Param {
                name: "return_within_radius",
                position: Some(1),
                value: "tiles",
                default: "0.5",
                doc: "How close counts as arrived.",
            },
        ],
        ignored: &[],
        note: None,
    ...
    Entry {
        ...
        params: &[Param {
            name: "name",
            position: Some(0),
            value: "a setpiece name",
            default: "nothing",
            doc: "Which structure to draw.",
        }],
        ignored: &[],
        note: None,
    },
    Entry {
        ...
        params: &[
            ...
            Param {
                ...
                value: "ms",
                default: "0",
                doc: "The wait between changes.",
            },
        ],
        ignored: &[
            Ignored {
                name: "relative_x",
                why: "the runtime changes the ground around the enemy",
                misread: false,
            },
            Ignored {
                name: "relative_y",
            ...
            Ignored {
                name: "persist",
                why: "the runtime always leaves the changed ground behind",
                misread: false,
            },
        ],
        note: None,
    ...
    Entry {
        ...
        params: &[Param {
            ...
            value: "an object name",
            default: "nothing",
            doc: "What appears in its place.",
        }],
        ignored: &[
            Ignored {
                name: "min",
                why: "the runtime leaves exactly one behind",
                misread: false,
            },
            Ignored {
                name: "max",
            ...
            Ignored {
                name: "probability",
                why: "the runtime always transforms",
                misread: false,
            },
        ],
        note: None,
    ...
    Entry {
        ...
        params: &[
            ...
            Param {
                ...
                value: "ms",
                default: "30000",
                doc: "How long the portal stays open.",
            },
        ],
        ignored: &[],
        note: None,
    ...
    Entry {
        ...
        params: &[
            ...
            Param {
                ...
                value: "a state name",
                default: "nothing",
                doc: "The state they are put into, which is one of theirs.",
            },
        ],
        ignored: &[],
        note: None,
    ...
    Entry {
        ...
        aliases: &[],
        kind: Kind::Behaviour,
        summary: "Hands whoever hurt it to the nearest one of a kind when it dies, so that \
                  killing the towers makes you eligible for the boss's bag.",
        params: &[
            Param {
                name: "target",
                position: Some(0),
            ...
            Param {
                ...
                value: "tiles",
                default: "50",
                doc: "How far out it looks for it.",
            },
        ],
        ignored: &[],
        note: Some(
            "No damage is dealt and no health moves. It is a merge of the damage counters and \
             nothing else.",
        ),
    },
    Entry {
        name: "copy_damage_on_death",
        aliases: &[],
        kind: Kind::Behaviour,
        ...
        ignored: &[],
        note: Some(
            "The method it ends in is empty in the original, so all fourteen uses of it in the \
             content amount to nothing. Use `transfer_damage_on_death` to move the credit.",
        ),
    },
    Entry {
        name: "prioritize",
...
pub const CONDITIONS: &[Entry] = &[
    Entry {
        ...
        params: &[Param {
            ...
            value: "ms",
            default: "1000",
            doc: "How long the state runs before this fires.",
        }],
        ignored: &[
            Ignored {
                name: "time",
                misread: true,
                why: "the compiler reads this as `after`, and the value written here is thrown away for the default of 1000ms",
            },
            Ignored {
                name: "randomized",
                misread: true,
                why: "write `timed_random` instead, which is the transition that varies its wait",
            },
            Ignored {
                name: "target_state",
                why: "the state to move to is what follows `->`",
                misread: false,
            },
        ],
        note: None,
    ...
    Entry {
        ...
        params: &[
            ...
            Param {
                ...
                value: "1 or 0",
                default: "0",
                doc: "Whether the wait varies at all. Without it the wait is exactly `time`.",
            },
        ],
        ignored: &[],
        note: None,
    ...
    Entry {
        ...
        params: &[
            Param {
                ...
                value: "tiles",
                default: "10",
                doc: "How close a player has to come.",
            },
            Param {
                name: "see_invis",
                position: Some(1),
                value: "true or false",
                default: "false",
                doc: "Whether invisible players count.",
            },
        ],
        ignored: &[Ignored {
            name: "dist",
            misread: true,
            why: "the compiler reads this as `radius`, and the value written here is thrown away for the default of 10 tiles",
        }],
        note: None,
    },
    Entry {
        ...
        params: &[Param {
            ...
            value: "tiles",
            default: "10",
            doc: "The distance that has to be empty.",
        }],
        ignored: &[Ignored {
            name: "dist",
            misread: true,
    ...
    Entry {
        ...
        params: &[Param {
            ...
            value: "0 to 1, or a percentage",
            default: "0.5",
            doc: "The share of health this fires at.",
        }],
        ignored: &[
            Ignored {
                name: "threshold",
                misread: true,
                why: "the compiler reads this as `fraction`, and the value written here is thrown away for the default of half health",
            },
            Ignored {
                name: "target_state",
                why: "the state to move to is what follows `->`",
    ...
    Entry {
        ...
        params: &[
            Param {
                ...
                value: "an object name",
                default: "nothing",
                doc: "What to look for. Any text argument is read as a name, whatever it is called.",
            },
            Param {
                name: "radius",
                position: Some(1),
    ...
    Entry {
        ...
        params: &[
            Param {
                ...
                value: "an object name",
                default: "nothing",
                doc: "What has to be gone. Any text argument is read as a name, whatever it is called, so several can be written.",
            },
            Param {
                name: "radius",
                position: Some(1),
    ...
    Entry {
        ...
        params: &[
            ...
            Param {
                ...
                value: "object names",
                default: "nothing",
                doc: "What has to be gone. Every text argument is read as a name.",
            },
        ],
        ignored: &[Ignored {
            name: "dist",
    ...
    Entry {
        ...
        params: &[Param {
            ...
            value: "hit points",
            default: "1",
            doc: "How much damage it takes to fire.",
        }],
        ignored: &[],
        note: None,
    },
    Entry {
        ...
        params: &[
            Param {
                ...
                value: "text",
                default: "nothing",
                doc: "What has to be said.",
            },
            Param {
                name: "within",
                position: Some(1),
                value: "tiles",
                default: "anywhere in the room",
                doc: "How close the speaker has to be.",
            },
            Param {
                name: "ignore_case",
                position: Some(3),
    ...
    Entry {
        ...
        params: &[Param {
            ...
            value: "ms",
            default: "250",
            doc: "How long it has to be still.",
        }],
        ignored: &[],
        note: None,
    },
...
pub const LOOT: &[Entry] = &[
    Entry {
        ...
        params: &[
            ...
            Param {
                ...
                value: "number",
                default: "0",
                doc: "How many of it have to drop together.",
            },
        ],
        ignored: &[
            Ignored {
                name: "item",
                misread: true,
                why: "the compiler reads the name as `name`, and an entry it cannot find a name for is dropped from the table entirely",
            },
            Ignored {
                name: "probability",
                misread: true,
                why: "the compiler reads the chance as `chance`, so the entry never drops",
            },
        ],
        note: None,
    },
    Entry {
        ...
        params: &[
            Param {
                ...
                value: "number",
                default: "0",
                doc: "Which tier of item.",
            },
            Param {
                name: "kind",
                position: Some(1),
                value: "weapon, ability, armor, ring or any",
                default: "any",
                doc: "What sort of item.",
            },
            Param {
                name: "chance",
                position: Some(2),
        ...
        ignored: &[
            Ignored {
                name: "type",
                misread: true,
                why: "the compiler reads the sort of item as `kind`, so any tier of item may drop",
            },
            Ignored {
                name: "probability",
                misread: true,
    ...
    Entry {
        ...
        params: &[Param {
            ...
            value: "0 to 1",
            default: "0",
            doc: "The share of damage a player has to have done.",
        }],
        ignored: &[],
        note: None,
    },
