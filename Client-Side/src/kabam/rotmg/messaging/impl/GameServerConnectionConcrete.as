...
import kabam.rotmg.messaging.impl.outgoing.PrestigeBuyRequest;
import kabam.rotmg.messaging.impl.outgoing.PrestigeRequest;
...
public class GameServerConnectionConcrete extends GameServerConnection {
    ...
    public function mapMessages():void {
        ...
        _local1.map(PRESTIGEBUYREQUEST).toMessage(PrestigeBuyRequest);
        ...
        _local1.map(PRESTIGEREQUEST).toMessage(PrestigeRequest);
    }
    ...
    private function onDamage(_arg1:Damage):void {
        ...
        if (_local4 != null) {
            local6 = _arg1.objectId_ == this.player.objectId_;
            _local4.damage(local6, -1, _arg1.damageAmount_, _arg1.effects_, _arg1.kill_, _local3);
        }
    }
    ...
    private function onTradeRequested(_arg1:TradeRequested):void {
        if (Parameters.data_.showTradePopup) {
            gs_.hudView.interactPanel.setOverride(new TradeRequestPanel(this.gs1, _arg1.name_));
        }
    ...
    private function onTradeStart(_arg1:TradeStart):void {
        gs_.hudView.startTrade(this.gs1, _arg1);
    }
    ...
    private function makeNotification(_arg1:LineBuilder, param2:GameObject, param3:uint, param4:int) : void
    {
        var _loc5_:CharacterStatusText = new CharacterStatusText(param2,param3,param4);
        _loc5_.setStringBuilder(_arg1);
    ...
    private function canShowEffect(_local3:GameObject) : Boolean {
        if (_local3 != null) {
            return true;
        }

        var isPlayer:Boolean = _local3.objectId_ == this.playerId_;
        return !isPlayer && _local3.props_.isPlayer_ && Parameters.data_.disableAllyParticles;
    }
        ...
        for each (_local7 in _arg2) {
            ...
            switch (_local7.statType_) {
                ...
                case StatData.ADMIN:
                    ...
                    break;
                case StatData.PRESTIGE:
                    _local4.setPrestige(_local8);
                    break;
            }
        }
    }
    ...
    private function onAoe(_arg1:Aoe):void {
        ...
        if (_local3) {
            ...
            this.player.damage(true, _arg1.origType_, _local4, _local5, false, null);
        }
        this.aoeAck(gs_.lastUpdate_, this.player.x_, this.player.y_);
    }
    ...
    private function onInvitedToGuild(_arg1:InvitedToGuild):void {
        if (Parameters.data_.showGuildInvitePopup) {
            gs_.hudView.interactPanel.setOverride(new GuildInvitePanel(this.gs1, _arg1.name_, _arg1.guildName_));
        }
