...
public class ChatListItemFactory {
    ...
    public function getAllWords(param1:String) : Array    {
        return param1.split(" ");
    }


    public function containsEmotes(param1:String) : Boolean
    {
    ...
    private function makeMessageLine(text:String):void {        var SBuilder:StringBuilder;
