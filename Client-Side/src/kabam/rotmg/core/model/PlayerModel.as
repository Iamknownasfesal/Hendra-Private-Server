...
public class PlayerModel {
    ...
    public const prestigeChanged:Signal = new Signal(int);
    ...
    public function getPrestige():int {
        return (this.charList.prestige_);
    }

    public function changePrestige(amount:int):void {
        this.charList.prestige_ = this.charList.prestige_ + amount;
        this.prestigeChanged.dispatch(this.charList.prestige_);
    }

    public function setPrestige(_arg1:int):void {
        if (this.charList.prestige_ != _arg1) {
            this.charList.prestige_ = _arg1;
            this.prestigeChanged.dispatch(_arg1);
        }
    }
