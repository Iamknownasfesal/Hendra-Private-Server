...
public class Camera {
    ...
    public static const CENTER_SCREEN_RECT:Rectangle = new Rectangle(-400, -450, 600, 600);
    ...
    {
        var _loc3_:Rectangle = this.correctViewingArea(Parameters.data_.centerOnPlayer);
