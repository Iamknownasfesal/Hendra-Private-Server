...
import com.company.assembleegameclient.map.SpawnRegionLibrary;
...
public class EditingScreen extends Sprite
{
    ...
    public var spawnRegionChooser_:SpawnRegionChooser;
    ...
    public function EditingScreen()
    {
        ...
        this.spawnRegionChooser_ = new SpawnRegionChooser();
        this.spawnRegionChooser_.x = this.chooserDropDown_.x;
        this.regionChooser_.y = _local3;
        this.choosers_[GroupDivider.GROUP_LABELS[8]] = this.spawnRegionChooser_;
    ...
    {
        var _local2:CheckBoxField = null;
    ...
    private function onTilesEvent(_arg1:TilesEvent) : void
    {
        ...
        var _local3:METile = null;
        var _local4:int = 0;
        var _local5:String = null;
        var _local6:String = null;
        var _local7:EditTileProperties = null;
        var _local8:Vector.<METile> = null;
        var _local9:Bitmap = null;
        var _local10:uint = 0;
    ...
    private function safeRemoveCategoryChildren() : *
    {
        ...
        SpriteUtil.safeRemoveChild(this,this.spawnRegionChooser_);
    ...
    private function onDropDownChange(_arg1:Event = null) : void
    {
        switch(this.chooserDropDown_.getValue())
        {
            ...
            case "SpawnRegions":
                this.setSearch("");
                this.safeRemoveCategoryChildren();
                SpriteUtil.safeAddChild(this,this.spawnRegionChooser_);
                this.chooser_ = this.spawnRegionChooser_;
                this.filter.enableDropDownFilter(false);
                this.filter.enableValueFilter(false);
                this.filter.enableDungeonFilter(false);
                return;
    ...
    private function getEntry(_arg1:METile) : Object
    {
        ...
        if(_arg1 != null)
        {
            ...
            if(_local3[Layer.SPAWNREGION] != -1)
            {
                _local4 = SpawnRegionLibrary.getIdFromType(_local3[Layer.SPAWNREGION]);
                _local2["spawnregions"] = [{"id":_local4}];
            }
        }
        return _local2;
    }
    ...
    private function onFileLoadComplete(_arg1:Event) : void
    {
        ...
        while(_local12 < _local8.bottom)
        {
            ...
            while(_local13 < _local8.right)
            {
                ...
                var _localregion = _local14["spawnregions"];
                if(_localregion != null)
                {
                    for each(_local18 in _localregion)
                    {
                        _local11 = SpawnRegionLibrary.idToType_[_local18["id"]];
                        this.meMap_.modifyTile(_local13,_local12,Layer.SPAWNREGION,_local11);
                    }
                }
                _local13++;
            }
