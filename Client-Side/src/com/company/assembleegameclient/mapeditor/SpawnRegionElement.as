...
public class SpawnRegionElement extends Element {

    public var regionXML_:XML;

    public function SpawnRegionElement(_arg1:XML) {
        super(int(_arg1.@type));
        this.regionXML_ = _arg1;
        var _local2:Shape = new Shape();
        _local2.graphics.beginFill(SpawnRegionLibrary.getColor(type_), 0.5);
