...
class MEMap extends Sprite
{
    ...
    public var spawnRegionMap_:BitmapData;
    ...
    function MEMap()
    {
        ...
        this.spawnRegionMap_ = new BitmapDataSpy(NUM_SQUARES,NUM_SQUARES,true,0);
    ...
    private function drawTile(_arg1:int, _arg2:int, _arg3:METile) : void
    {
        ...
        this.spawnRegionMap_.setPixel32(_arg1,_arg2,0);
        if(_arg3 == null)
        {
            this.groundLayer_.erase(_local4);
            this.objectLayer_.erase(_local4);
        ...
        if(_arg3.types_[Layer.REGION] != -1)
        {
            ...
            this.regionMap_.setPixel32(_arg1,_arg2,1593835520 | _local7);
        }
        if(_arg3.types_[Layer.SPAWNREGION] != -1)
        {
            _local7 = SpawnRegionLibrary.getColor(_arg3.types_[Layer.SPAWNREGION]);
            this.spawnRegionMap_.setPixel32(_arg1,_arg2,1593835520 | _local7);
        }
    }
    ...
    public function draw() : void
    {
        ...
        if(this.ifShowRegionLayer_)
        {
            ...
            if(this.zoom_ > 2)
            {
                ...
                _local4.copyPixels(this.spawnRegionMap_,new Rectangle(this.posT_.x_,this.posT_.y_,_local1,_local1),PointUtil.ORIGIN);
            ...
            else
            {
                ...
                this.map_.draw(this.spawnRegionMap_,_local2,null,null,this.map_.rect);
            }
        }
        this.drawOverlay();
    }
    ...
    private function generateThumbnail() : ByteArray
    {
        ...
        _local3.draw(this.spawnRegionMap_,_local4);
    ...
    public function getMapStatistics() : Object
    {
        ...
        for each(_local6 in this.tileDict_)
        {
            ...
            if(_local6.types_[Layer.SPAWNREGION] != -1)
            {
                if(_local6.types_[Layer.SPAWNREGION] == SpawnRegionLibrary.EXIT_REGION_TYPE)
                {
                    _local3++;
                }
                if(_local6.types_[Layer.SPAWNREGION] == SpawnRegionLibrary.ENTRY_REGION_TYPE)
                {
                    _local4++;
                }
            }
