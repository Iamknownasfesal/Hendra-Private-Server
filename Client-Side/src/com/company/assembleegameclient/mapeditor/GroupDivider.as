...
public class GroupDivider
{
    ...
    public static const GROUP_LABELS:Vector.<String> = new <String>["Ground","Basic Objects","Enemies","Walls","3D Objects","All Objects","Regions","Dungeons","Spawn Regions"];
    ...
    public static function divideObjects() : void
    {
        ...
        var _local12:XML = null;
        var _local13:XML = null;
        var _local14:PlayerModel = null;
        var _local15:String = null;
        var _local16:XML = null;
        ...
        for each(_local12 in ObjectLibrary.xmlLibrary_)
        {
            ...
            if(!(_local12.hasOwnProperty("Item") || _local12.hasOwnProperty("Player") || _local12.Class == "Projectile" || _local12.Class == "PetSkin" || _local12.Class == "Pet" || _local10.search("Spawner") >= 0 && !_local14.isAdmin()))
            {
                if(!(!_local14.isAdmin() && HIDE_OBJECTS_IDS.indexOf(_local10) >= 0))
                {
                    ...
                    else if(_local12.hasOwnProperty("Model"))
                    {
                        _local5[_local9] = _local12;
                        _local7[_local9] = _local12;
                        _local11 = true;
                    }
                    else if(_local12.hasOwnProperty("Enemy"))
                    {
                        _local4[_local9] = _local12;
                        _local7[_local9] = _local12;
                        _local11 = true;
                    }
                    else if(_local12.hasOwnProperty("Static") && !_local12.hasOwnProperty("Price"))
                    {
                        _local3[_local9] = _local12;
                        _local7[_local9] = _local12;
                        _local11 = true;
                    }
                    else if(_local14.isAdmin())
                    {
                        _local7[_local9] = _local12;
                    }
        ...
        if(_local14.isAdmin())
        {
            ...
            for each(_local16 in SpawnRegionLibrary.xmlLibrary_)
            {
                _local2[int(_local16.@type)] = _local16;
            }
        }
    ...
    public static function getCategoryByType(_arg1:int, _arg2:int) : String
    {
        ...
        if(_arg2 == Layer.SPAWNREGION)
        {
            return GROUP_LABELS[8];
        }
