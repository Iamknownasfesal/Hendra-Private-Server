...
public class MapUserInput {
    ...
    public var inventoryTog:Boolean = true;
    ...
    private function onKeyDown(_arg1:KeyboardEvent):void {
        ...
        switch (_arg1.keyCode) {
            ...
            case Parameters.data_.inventoryToggle:
                if(this.inventoryTog)
                {
                    this.inventoryTog = false;
                    this.InventoryToggleFunc(inventoryTog);
                }
                else if(!this.inventoryTog)
                {
                    this.inventoryTog = true;
                    this.InventoryToggleFunc(inventoryTog);
                }
                break;
    ...
    private function InventoryToggleFunc(toggleInv:Boolean):void
    {
        if(!toggleInv)
        {
            this.gs_.hudView.tabStrip.visible = false;
            this.gs_.hudView.equippedGrid.visible = false;
            this.gs_.hudView.equippedGridBG.visible = false;
        }
        else if(toggleInv)
        {
            this.gs_.hudView.tabStrip.visible = true;
            this.gs_.hudView.equippedGrid.visible = true;
            this.gs_.hudView.equippedGridBG.visible = true;
        }
    }
