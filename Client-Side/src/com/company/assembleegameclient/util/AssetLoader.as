...
public class AssetLoader {
    ...
    private function addImages():void {
        ...
        AssetLibrary.addImageSet("lostHallsObjects8x8", new EmbeddedAssets.lostHallsObjects8x8_().bitmapData, 8, 8);
        AssetLibrary.addImageSet("lofiObj7", new EmbeddedAssets.lofiObj7Embed_().bitmapData, 8, 8);
        AssetLibrary.addImageSet("lofiObj8", new EmbeddedAssets.lofiObj8Embed_().bitmapData, 16, 16);
    ...
    private function parseSpawnRegionFiles():void {
        var _local1:*;
        for each (_local1 in EmbeddedData.spawnRegionFiles) {
            SpawnRegionLibrary.parseFromXML(XML(_local1));
        }
    }
