...
public class Options extends Sprite {
    ...
    {
        return new <StringBuilder>[new StaticStringBuilder("Off"),new StaticStringBuilder("Locked"),new StaticStringBuilder("Guild"),new StaticStringBuilder("Both")];
    }
    ...
    private function addHotKeysOptions():void {
        ...
        this.addOptionAndPosition(new KeyMapper("inventoryToggle", "Inventory On / Off","Inventory."));
    ...
    private function addExperimentalOptions():void {
        ...
        this.addOptionAndPosition(new ChoiceOption("toggleToMaxText",makeOnOffLabels(),[true,false],"Toggle Pots to Max Text","Shows how many pots are needed to max after the \"|\" symbol.",onToMaxTextToggle));
        ...
        this.addOptionAndPosition(new ChoiceOption("projectileOutline", makeOnOffLabels(), [true, false], "Toggle Projectile Outline", "This toggles whether to outline projectiles", null));
