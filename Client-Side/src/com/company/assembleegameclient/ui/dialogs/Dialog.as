...
public class Dialog extends Sprite {
    ...
    protected function initText(_arg1:String):void {
        this.textText_ = new TextFieldDisplayConcrete().setSize(14).setColor(0xffffff);
    ...
    private function initNonNullTitleAndAdd(_arg1:String):void {
        if (_arg1 != null) {
            this.titleText_ = new TextFieldDisplayConcrete().setSize(18).setColor(0xcccccc);
    ...
    private function drawBackground() : void
    {
        ...
        GraphicsUtil.drawCutEdgeRect(0,0,this.dialogWidth,this.getBoxHeight() + this.bottomSpace,4,[0,0,0,0],this.path_);
