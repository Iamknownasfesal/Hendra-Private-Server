...
public class SlotComparisonFactory {
    ...
    public function SlotComparisonFactory() {
        ...
        this.hash[ItemConstants.BELT_TYPE] = _local1;
        this.hash[ItemConstants.AMULET_TYPE] = _local1;
        this.hash[ItemConstants.WINGS_TYPE] = _local1;
        this.hash[ItemConstants.ComingSoon] = _local1;
    }
