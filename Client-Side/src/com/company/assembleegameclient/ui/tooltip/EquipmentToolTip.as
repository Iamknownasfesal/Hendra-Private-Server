...
public class EquipmentToolTip extends ToolTip {
    ...
    private function addTitle():void {
        ...
        {
            this.titleText = new TextFieldDisplayConcrete().setSize(16).setColor(TooltipHelper.SET_COLOR).setBold(true).setTextWidth((((MAX_WIDTH - this.icon.width) - 4) - 30)).setWordWrap(true);
        }
        else if (this.objectXML.hasOwnProperty("Legendary"))
        {
            this.titleText = new TextFieldDisplayConcrete().setSize(16).setColor(TooltipHelper.LEGENDARY_COLOR).setBold(true).setTextWidth((((MAX_WIDTH - this.icon.width) - 4) - 30)).setWordWrap(true);
        }
        else if (this.objectXML.hasOwnProperty("Special"))
        {
            this.titleText = new TextFieldDisplayConcrete().setSize(16).setColor(TooltipHelper.SPECIAL_COLOR).setBold(true).setTextWidth((((MAX_WIDTH - this.icon.width) - 4) - 30)).setWordWrap(true);
        }
        else
        {
            this.titleText = new TextFieldDisplayConcrete().setSize(16).setColor(0xFFFFFF).setBold(true).setTextWidth((((MAX_WIDTH - this.icon.width) - 4) - 30)).setWordWrap(true);
        }
    ...
    private function makeRestrictionList():void {
        ...
        if (this.objectXML.hasOwnProperty("@setType")) {
            this.restrictions.push(new Restriction("Rarity: Set", 0xFF9900, false));
        }
        if (this.objectXML.hasOwnProperty("Special")) {
            this.restrictions.push(new Restriction("Rarity: Special", 0xFF0000, false));
        }
        if (this.objectXML.hasOwnProperty("Legendary")) {
            this.restrictions.push(new Restriction("Rarity: Legendary", 0xFFFF00, false));
        }
