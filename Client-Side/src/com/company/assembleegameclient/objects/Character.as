...
public class Character extends GameObject {
    ...
    override public function damage(param1:Boolean, _arg1:int, _arg2:int, _arg3:Vector.<uint>, _arg4:Boolean, _arg5:Projectile):void {
        super.damage(param1, _arg1, _arg2, _arg3, _arg4, _arg5);
        if (dead_) {
