...
public class GameObject extends BasicObject {
    ...
    override public function update(_arg1:int, _arg2:int):Boolean {
        ...
        if (distToEnd() > 0.1)
        {
            _local4 = _arg2 * 0.0020666;
            _local5 = interpolate(this.tickPosition_.x, this.x_, _local4);
            _local6 = interpolate(this.tickPosition_.y, this.y_, _local4);
    ...
    public function damage(param1:Boolean, _arg1:int, _arg2:int, _arg3:Vector.<uint>, _arg4:Boolean, _arg5:Projectile):void {
        var _local7:int;
        var _local8:uint;
    ...
    public function showDamageText(_arg1:int, _arg2:Boolean):void {
        var _local3:String = ("-" + _arg1 + "[" + this.hp_ +"]");
    ...
    override public function draw(_arg1:Vector.<IGraphicsData>, _arg2:Camera, _arg3:int):void {
        ...
        _arg1.push(this.path_);
        _arg1.push(GraphicsUtil.END_FILL);
        if (((((((!(this.isPaused())) && (((this.condition_[ConditionEffect.CE_FIRST_BATCH]) || (this.condition_[ConditionEffect.CE_SECOND_BATCH]))))) && (!(Parameters.screenShotMode_)))))) {
