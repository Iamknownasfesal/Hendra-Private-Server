...
public class Player extends Character {
    ...
    public var prestigeWereChanged:Signal;
    ...
    public function Player(_arg1:XML) {
        ...
        this.prestigeWereChanged = new Signal();
    ...
    public static function fromPlayerXML(param1:String, param2:XML) : Player
    {
        ...
        _loc5_.maxHP_ = _loc5_.maxHPBoost_ + int(param2.MaxHitPoints);
        _loc5_.hp_ = int(param2.HitPoints);
        _loc5_.maxMP_ = _loc5_.maxMPBoost_ + int(param2.MaxMagicPoints);
        _loc5_.mp_ = int(param2.MagicPoints);
        _loc5_.attack_ = _loc5_.attackBoost_ + int(param2.Attack);
        _loc5_.defense_ = _loc5_.defenseBoost_ + int(param2.Defense);
        _loc5_.speed_ = _loc5_.speedBoost_ + int(param2.Speed);
        _loc5_.dexterity_ = _loc5_.dexterityBoost_ + int(param2.Dexterity);
        _loc5_.vitality_ = _loc5_.vitalityBoost_ + int(param2.HpRegen);
        _loc5_.wisdom_ = _loc5_.wisdomBoost_ + int(param2.MpRegen);
        _loc5_.tex1Id_ = int(param2.Tex1);
        _loc5_.tex2Id_ = int(param2.Tex2);
        _loc5_.hasBackpack_ = param2.HasBackpack == "1";
        return _loc5_;
    }
    ...
    public function setPrestige(_arg1:int):void {
        this.prestige_ = _arg1;
        this.prestigeWereChanged.dispatch();
    }
    ...
    override public function update(currentTime:int, deltaMS:int):Boolean {
        ...
        if (map_.player_ == this &&
            ...
            damage(true,-1, dmg, conditionEffects, hp_ <= dmg, null);
    ...
    override public function draw(_arg1:Vector.<IGraphicsData>, _arg2:Camera, _arg3:int) : void
    {
        switch(Parameters.data_.hideList)
        {
            ...
            case 2:
                ...
                break;
            case 3:
                if(this != map_.player_ && !this.starred_ && !this.isFellowGuild_)
                {
                    return;
                }
                break;
