...
namespace common
{
    ...
    public class DbAccount : RedisObject
    {
        ...
        public int Prestige
        {
            get { return GetValue<int>("prestige"); }
            set { SetValue<int>("prestige", value); }
        }

        public int TotalPrestige
        {
            get { return GetValue<int>("totalPrestige"); }
            set { SetValue<int>("totalPrestige", value); }
        }
        ...
        public bool Alpha
        {
            get { return GetValue<bool>("alpha"); }
            set { SetValue<bool>("alpha", value); }
        }
    ...
    public abstract class RInventory : RedisObject
    {
        ...
        public ushort[] Items
        {
            get { return GetValue<ushort[]>(Field) ?? Enumerable.Repeat((ushort)0xffff, 24).ToArray(); }
