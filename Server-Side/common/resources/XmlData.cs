            ...
            foreach (var elem in root.XPathSelectElements("//Object"))
            {
                ...
                switch (cls)
                {
                    ...
                    case "Player":
                        ...
                        slotType2ItemType[pDesc.SlotTypes[4]] = ItemType.Amulet;
                        slotType2ItemType[pDesc.SlotTypes[5]] = ItemType.Belt;
                        slotType2ItemType[pDesc.SlotTypes[6]] = ItemType.Wings;
                        slotType2ItemType[pDesc.SlotTypes[7]] = ItemType.ComingSoon;
