...
namespace wServer.realm
{
    class Oryx
    {
        ...
        private readonly List<Tuple<string, ISetPiece>> _events = new List<Tuple<string, ISetPiece>>()
        {
            ...
            Tuple.Create("The Magicial lord of sky", (ISetPiece) new LordOfSky()),
           // Tuple.Create("shtrs Defense System", (ISetPiece) new Avatar()),
            Tuple.Create("LH Sentry", (ISetPiece) new Spooky()),
        ...
        private static readonly Tuple<string, TauntData>[] CriticalEnemies = new Tuple<string, TauntData>[]
        {
            ...
            Tuple.Create("The Magicial lord of sky", new TauntData()
            {
                Spawn = new string[] {
                    "WHO COME TO THIS REALM?",
                },
                Killed = new string[] {
                    "HOW CAN YOU KILL MY SKY LORD????????????!!"
                }
            }),
            Tuple.Create("LH Sentry", new TauntData()
            {
                Spawn = new string[] {
                    "I'm very spooky boiii sexy",
                },
             }),
