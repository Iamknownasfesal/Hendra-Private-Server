...
namespace wServer.realm.entities
{
    ...
    public partial class Player : Character, IContainer, IPlayer
    {
        ...
        private readonly SV<int> _prestige;
        public int Prestige
        {
            get { return _prestige.GetValue(); }
            set { _prestige.SetValue(value); }
        }
        ...
        protected override void ImportStats(StatsType stats, object val)
        {
            ...
            switch (stats)
            {
                ...
                case StatsType.Inventory12: Inventory[12] = (int)val == -1 ? null : items[(ushort)(int)val]; break;
                case StatsType.Inventory13: Inventory[13] = (int)val == -1 ? null : items[(ushort)(int)val]; break;
                case StatsType.Inventory14: Inventory[14] = (int)val == -1 ? null : items[(ushort)(int)val]; break;
                case StatsType.Inventory15: Inventory[15] = (int)val == -1 ? null : items[(ushort)(int)val]; break;
                case StatsType.BackPack0: Inventory[16] = (int)val == -1 ? null : items[(ushort)(int)val]; break;
                case StatsType.BackPack1: Inventory[17] = (int)val == -1 ? null : items[(ushort)(int)val]; break;
                case StatsType.BackPack2: Inventory[18] = (int)val == -1 ? null : items[(ushort)(int)val]; break;
                case StatsType.BackPack3: Inventory[19] = (int)val == -1 ? null : items[(ushort)(int)val]; break;
                case StatsType.BackPack4: Inventory[20] = (int)val == -1 ? null : items[(ushort)(int)val]; break;
                case StatsType.BackPack5: Inventory[21] = (int)val == -1 ? null : items[(ushort)(int)val]; break;
                case StatsType.BackPack6: Inventory[22] = (int)val == -1 ? null : items[(ushort)(int)val]; break;
                case StatsType.BackPack7: Inventory[23] = (int)val == -1 ? null : items[(ushort)(int)val]; break;
                ...
                case StatsType.Prestige: Prestige = (int)val; break;
            }
        }
        ...
        protected override void ExportStats(IDictionary<StatsType, object> stats)
        {
            ...
            stats[StatsType.Prestige] = Prestige;
            ...
            stats[StatsType.Inventory12] = Inventory[12]?.ObjectType ?? -1;
            stats[StatsType.Inventory13] = Inventory[13]?.ObjectType ?? -1;
            stats[StatsType.Inventory14] = Inventory[14]?.ObjectType ?? -1;
            stats[StatsType.Inventory15] = Inventory[15]?.ObjectType ?? -1;
            stats[StatsType.BackPack0] = Inventory[16]?.ObjectType ?? -1;
            stats[StatsType.BackPack1] = Inventory[17]?.ObjectType ?? -1;
            stats[StatsType.BackPack2] = Inventory[18]?.ObjectType ?? -1;
            stats[StatsType.BackPack3] = Inventory[19]?.ObjectType ?? -1;
            stats[StatsType.BackPack4] = Inventory[20]?.ObjectType ?? -1;
            stats[StatsType.BackPack5] = Inventory[21]?.ObjectType ?? -1;
            stats[StatsType.BackPack6] = Inventory[22]?.ObjectType ?? -1;
            stats[StatsType.BackPack7] = Inventory[23]?.ObjectType ?? -1;
            ...
            : base(client.Manager, client.Character.ObjectType)
        {
            ...
            _prestige = new SV<int>(this, StatsType.Prestige, client.Account.Prestige, true);
        ...
        private bool Nexus(string killer)
        {
            if (!(Owner is Nexus))
                return false;
        ...
        private void AnnounceDeath(string killer)
        {
            ...
            var deathMessage = string.Format(
                "{0} died to {1}! ({2}/8, {3} Fame)",
                Name, killer, maxed, _client.Character.FinalFame);

            SendWebHook.Post(selectedTitle: "Death", selectedDescription: "Someone Died!", name: Name, selectedType: 0,killername: killer,maxed: maxed.ToString(),finalFame: _client.Character.FinalFame.ToString());
