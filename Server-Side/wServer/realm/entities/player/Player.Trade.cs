...
namespace wServer.realm.entities
{
    partial class Player
    {
        ...
        public void RequestTrade(string name)
        {
            ...
            if (_client.Account.Rank >= 40)
            {
                SendError("Your rank is too high to give/trade items to this person!");
                return;
            }
            ...
            if (target.Rank >= 40)
            {
                SendError("Your rank is too low to give/trade items to this person.!");
                return;
            }
